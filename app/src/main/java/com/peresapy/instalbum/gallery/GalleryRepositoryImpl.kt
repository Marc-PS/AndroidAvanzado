...
import com.peresapy.instalbum.network.ImgurApi
import com.peresapy.instalbum.network.NetworkAlbum
import com.peresapy.instalbum.network.NetworkGallery
import com.peresapy.instalbum.room.ImageDAO
import com.peresapy.instalbum.room.RoomImage
    ...
    private fun NetworkGallery.toDomain(): Gallery {
        val images = data.filter { image ->
            ...
            Image(
                ...
                imagesInAlbum = image.images_count ?: 0
            )
        }
    ...
    private fun List<RoomImage>.toDomain(): Gallery {
        return Gallery(map { roomImage ->
            Image(
                ...
                imagesInAlbum = roomImage.imagesInAlbum
            )
        })
    }
    ...
    private fun Gallery.toRoom(imageType: RoomImage.ImageType): List<RoomImage> =
        images.map { image ->
            RoomImage(
                ...
                imagesInAlbum = image.imagesInAlbum
            )
        }
}